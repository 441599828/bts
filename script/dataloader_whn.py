...
class DataLoadPreprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # CarlaDataset
        focal = 392.871
        # 1024 / (2.0 * np.tan(105 * np.pi / 360.0))
        if self.mode == 'train':
...
class ToTensor(object):
    def __init__(self, mode):
        ...
        # Carla mean and bias
        # img_size:1024x576
        # meanRGB:[33.96981349 41.81856017 47.70722021]
        # stdRGB:[47.84297547 51.68612676 54.98686106]
        self.normalize = transforms.Normalize(mean=[0.133, 0.163, 0.186], std=[0.187, 0.202, 0.215])
